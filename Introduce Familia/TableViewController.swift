...
class TableViewController: UITableViewController {
    ...
    var listOfFamilyMembers = ["dad", "mom", "koen", "navy"]
    var indexRow = 0
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        content.text = listOfFamilyMembers[indexPath.row]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if listOfFamilyMembers[indexRow] == "mom" {
            destination.nameOfPerson = "Kylie"
        } else if listOfFamilyMembers[indexRow] == "dad" {
            destination.nameOfPerson = "Dax"
        } else if listOfFamilyMembers[indexRow] == "koen" {
            destination.nameOfPerson = "Koen"
        } else if listOfFamilyMembers[indexRow] == "navy" {
